  ...
  render() {
    ...
    return (
      <>
                ...
                arrPatientS5.map((item, index) => {
                  return item.statusId === "S5" ? (
                    <tr key={index}>
                      ...
                      <td style={{textAlign: "center"}}>{item.bookingType}</td>
        ...
        <div className="col-12 table-m-p mt-3">
          <p className="h5" style={{color: "white", marginTop: "50px", background: "red"}}>
                ...
                arrPatientS6.map((item, index) => {
                  return item.statusId === "S6" ? (
                    <tr key={index}>
                      ...
                      <td>{this.convertTimestampToDate(item.date)}</td>
                      <td style={{textAlign: "center"}}>{item.bookingType}</td>
                      <td style={{background: "red"}} className="status">{item.statusTypeData.valueVI}</td>
        ...
        <div className="col-12 table-m-p mt-3">
          <p className="h5" style={{color: "#fff", fontWeight: "bold", marginTop:"50px", background: "black"}}>
            Danh sách đen
          </p>
          <table style={{ width: "100%" }}>
            <tbody>
                ...
                arrPatientS7.map((item, index) => {
                  return item.statusId === "S7" ? (
                    <tr key={index}>
                      ...
                      <td>{this.convertTimestampToDate(item.date)}</td>
                      <td style={{textAlign: "center"}}>{item.bookingType}</td>
                      <td style={{background: "#000"}} className="status1">X</td>
