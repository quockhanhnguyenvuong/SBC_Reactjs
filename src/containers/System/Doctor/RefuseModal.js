    ...
    return (
      ...
      >
        <div className="modal-header">
            <h5 className="modal-title">Bạn có chắc chắn từ chối lịch hẹn này?</h5>
          ...
          <ModalFooter>
            <Button color="primary" className="btn_modalFooter" onClick={this.handleSendRefuse}>Send</Button>{' '}
            <Button color="warning" className="btn_modalFooter" onClick={closeRefuseModal}>Cancel</Button>
          </ModalFooter>
      </Modal>
