...
export class ManagePatient extends Component {
  ...
  getDataPatientS3 = async () => {
    ...
    for (let i = 0; i < arr.length; i++) {
      if (arr[i].bookingType === "ONLINE")
        if (arr[i].statusId === "S3") arrS3[countS3++] = arr[i];
    }
      ...
      <>
        ...
        >
          <div className="manage-patient-container">
            ...
            <div className="m-p-body row">
              ...
              <div className="col-12 table-m-p mt-3">
                ...
                >
                  Danh sách bệnh nhân đặt lịch khám trực tiếp:
                </p>
          ...
          <div className="col-12 table-m-p mt-3 ">
            <p
              className="h5"
              style={{ marginTop: "50px", marginLeft: "20px", width: "97.5%" }}
            >
            ...
            >
              <tbody>
                ...
                {arrayPatientS3 && arrayPatientS3.length > 0 ? (
